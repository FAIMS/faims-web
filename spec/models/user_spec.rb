...
describe User do
  ...
  describe "Named Scopes" do
    describe "Users Pending Approval Scope" do
      it "should return users that are unapproved ordered by email address" do
        u1 = FactoryBot.create(:user, :status => 'U', :email => "fasdf1@intersect.org.au")
        u2 = FactoryBot.create(:user, :status => 'A')
        u3 = FactoryBot.create(:user, :status => 'U', :email => "asdf1@intersect.org.au")
        u2 = FactoryBot.create(:user, :status => 'R')
    ...
    describe "Approved Users Scope" do
      it "should return users that are approved ordered by email address" do
        u1 = FactoryBot.create(:user, :status => 'A', :email => "fasdf1@intersect.org.au")
        u2 = FactoryBot.create(:user, :status => 'U')
        u3 = FactoryBot.create(:user, :status => 'A', :email => "asdf1@intersect.org.au")
        u4 = FactoryBot.create(:user, :status => 'R')
        u5 = FactoryBot.create(:user, :status => 'D')
    ...
    describe "Deactivated or Approved Users Scope" do
      it "should return users that are approved ordered by email address" do
        ...
        u3 = FactoryBot.create(:user, :status => 'A', :email => "asdf1@intersect.org.au")
        u4 = FactoryBot.create(:user, :status => 'R')
        u5 = FactoryBot.create(:user, :status => 'D', :email => "zz@inter.org")
        User.deactivated_or_approved.should eq([u3, u1, u5])
      end
    end
    describe "Approved superusers Scope" do
      it "should return users that are approved ordered by email address" do
        super_role = FactoryBot.create(:role, :name => "superuser")
        other_role = FactoryBot.create(:role, :name => "Other")
        u1 = FactoryBot.create(:user, :status => 'A', :role => super_role, :email => "fasdf1@intersect.org.au")
        u2 = FactoryBot.create(:user, :status => 'A', :role => other_role)
        u3 = FactoryBot.create(:user, :status => 'U', :role => super_role)
        u4 = FactoryBot.create(:user, :status => 'R', :role => super_role)
        u5 = FactoryBot.create(:user, :status => 'D', :role => super_role)
  ...
  describe "Approve Access Request" do
    it "should set the status flag to A" do
      user = FactoryBot.create(:user, :status => 'U')
  ...
  describe "Status Methods" do
    context "Active" do
      it "should be active" do
        user = FactoryBot.create(:user, :status => 'A')
    ...
    context "Rejected" do
      it "should not be active" do
        user = FactoryBot.create(:user, :status => 'R')
        user.approved?.should be_false
      end
      it "should not be pending approval" do
        user = FactoryBot.create(:user, :status => 'R')
  ...
  describe "Update password" do
    it "should fail if current password is incorrect" do
      user = FactoryBot.create(:user, :password => "Pass.123")
  ...
  describe "Has permission method" do
    it "should return true if the specified permission is in the list" do
      ...
      user.role.permissions = [FactoryBot.create(:permission, :entity => "Abc", :action => "def")]
  ...
  describe "Find the number of superusers method" do
    it "should return true if there are at least 2 superusers" do
      super_role = FactoryBot.create(:role, :name => 'superuser')
      user_1 = FactoryBot.create(:user, :role => super_role, :status => 'A', :email => 'user1@intersect.org.au')
      user_2 = FactoryBot.create(:user, :role => super_role, :status => 'A', :email => 'user2@intersect.org.au')
      user_3 = FactoryBot.create(:user, :role => super_role, :status => 'A', :email => 'user3@intersect.org.au')
    ...
    it "should return true if the logged in user does not match the user record being modified" do
      super_role = FactoryBot.create(:role, :name => 'superuser')
      research_role = FactoryBot.create(:role, :name => 'Researcher')
      user_1 = FactoryBot.create(:user, :role => super_role, :status => 'A', :email => 'user1@intersect.org.au')
      user_2 = FactoryBot.create(:user, :role => research_role, :status => 'A', :email => 'user2@intersect.org.au')
  ...
  describe "Get superuser emails" do
    it "should find all approved superusers and extract their email address" do
      ...
      super_1 = FactoryBot.create(:user, :role => super_role, :status => "A", :email => "a@intersect.org.au")
      super_2 = FactoryBot.create(:user, :role => super_role, :status => "U", :email => "b@intersect.org.au")
      super_3 = FactoryBot.create(:user, :role => super_role, :status => "A", :email => "c@intersect.org.au")
      super_4 = FactoryBot.create(:user, :role => super_role, :status => "D", :email => "d@intersect.org.au")
      super_5 = FactoryBot.create(:user, :role => super_role, :status => "R", :email => "e@intersect.org.au")
      admin = FactoryBot.create(:user, :role => admin_role, :status => "A", :email => "f@intersect.org.au")
